...
from ProjectTournoi.tools.constants import TITLE_PLAYERS_ALPH, \
    TITLE_PLAYERS_CLASS
...
class Controller_reports:
    ...
    def print_end_views(self, tournoi):
        """list of tournaments"""
        cv.CreateEndView.list_tournaments(self, tournoi.area, tournoi.date,
                                          tournoi.description)
        """list of players"""
        cv.CreateEndView.list_players(self, tournoi.area, tournoi.date,
                                      tournoi.players)
        """list of rounds"""
        ...
        cv.CreateEndView.list_results_tournaments(self,  1,
                                                  tournoi.date,
                                                  tournoi.players)
